...
if (isset($_POST['signup'])) {
    ...
    $insertquery = "insert into studentlist(studentname, studentnumber, studentemail, studentyear, studentsection, studentcontactnumber, studentpassword, votedpres, votedvpresi, votedvprese, votedgs, votedds, votedtrea, votedaudi, votedpiom, votedpiof) values ('$sname', '$sno', '$smail', '$syear', '$ssection', '$scno', '$spassword', '$votingstatus', '$votingstatus', '$votingstatus', '$votingstatus', '$votingstatus', '$votingstatus', '$votingstatus', '$votingstatus', '$votingstatus')";
